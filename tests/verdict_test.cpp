...
TEST_CASE("every ReasonCode has a stable name, class, and exit band") {
    ...
    const Row rows[] = {
        {ReasonCode::GPU_COUNT_MISMATCH,           "GPU_COUNT_MISMATCH",           ReasonClass::HARD,   ExitCode::FAIL_CONTRACT},
        {ReasonCode::GPU_NAME_MISMATCH,            "GPU_NAME_MISMATCH",            ReasonClass::HARD,   ExitCode::FAIL_CONTRACT},
        {ReasonCode::GPU_MEMORY_BELOW_MIN,         "GPU_MEMORY_BELOW_MIN",         ReasonClass::HARD,   ExitCode::FAIL_CONTRACT},
        {ReasonCode::MIG_MODE_MISMATCH,            "MIG_MODE_MISMATCH",            ReasonClass::HARD,   ExitCode::FAIL_CONTRACT},
        {ReasonCode::CUDA_VISIBLE_COUNT_BELOW_MIN, "CUDA_VISIBLE_COUNT_BELOW_MIN", ReasonClass::REPORT, std::nullopt},
        {ReasonCode::NVML_LIBRARY_NOT_FOUND,       "NVML_LIBRARY_NOT_FOUND",       ReasonClass::HARD,   std::nullopt},
        ...
        {ReasonCode::CUDA_LIBRARY_NOT_FOUND,       "CUDA_LIBRARY_NOT_FOUND",       ReasonClass::HARD,   ExitCode::FAIL_USABILITY},
        {ReasonCode::CUDA_INIT_FAILED,             "CUDA_INIT_FAILED",             ReasonClass::HARD,   ExitCode::FAIL_USABILITY},
        {ReasonCode::CUDA_CONTEXT_FAILED,          "CUDA_CONTEXT_FAILED",          ReasonClass::HARD,   ExitCode::FAIL_USABILITY},
        {ReasonCode::CUDA_SMOKE_FAILED,            "CUDA_SMOKE_FAILED",            ReasonClass::HARD,   ExitCode::FAIL_USABILITY},
        ...
        {ReasonCode::UNKNOWN_FIELD_IGNORED,        "UNKNOWN_FIELD_IGNORED",        ReasonClass::REPORT, std::nullopt},
        {ReasonCode::DRIVER_VERSION_BELOW_MIN,     "DRIVER_VERSION_BELOW_MIN",     ReasonClass::WARN,   ExitCode::WARN},
        {ReasonCode::ECC_MODE_MISMATCH,            "ECC_MODE_MISMATCH",            ReasonClass::HARD,   ExitCode::FAIL_CONTRACT},
        {ReasonCode::ECC_UNCORRECTABLE_DETECTED,   "ECC_UNCORRECTABLE_DETECTED",   ReasonClass::HARD,   ExitCode::FAIL_CONTRACT},
        {ReasonCode::ROW_REMAP_PENDING,            "ROW_REMAP_PENDING",            ReasonClass::HARD,   ExitCode::FAIL_CONTRACT},
        {ReasonCode::ROW_REMAP_FAILURE,            "ROW_REMAP_FAILURE",            ReasonClass::HARD,   ExitCode::FAIL_STACK},
        {ReasonCode::RETIRED_PAGES_PENDING,        "RETIRED_PAGES_PENDING",        ReasonClass::WARN,   ExitCode::WARN},
        {ReasonCode::GPU_RECOVERY_ACTION_REQUIRED, "GPU_RECOVERY_ACTION_REQUIRED", ReasonClass::HARD,   ExitCode::FAIL_STACK},
        {ReasonCode::FABRIC_NOT_READY,             "FABRIC_NOT_READY",             ReasonClass::HARD,   ExitCode::FAIL_USABILITY},
        {ReasonCode::FABRIC_NOT_APPLICABLE,        "FABRIC_NOT_APPLICABLE",        ReasonClass::REPORT, ExitCode::OK},
    };
